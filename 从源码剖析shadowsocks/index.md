...
很多人第一次接触 Shadowsocks，只把它当作一个代理工具。

但是从源码角度看，Shadowsocks 是一个非常适合学习网络编程的项目。它代码量不大，却包含了现代网络服务端开发中的很多核心思想：
...
阅读 Shadowsocks 源码，可以帮助我们理解一个代理程序从建立连接，到数据转发，再到连接关闭的完整过程。

本文以 Python 版 Shadowsocks 为例，分析它内部的设计。
...
阅读 Shadowsocks 源码最大的价值，不是学习如何实现一个代理。而是理解：一个高性能网络程序如何工作。
...
> URL: http://localhost:1313/%E4%BB%8E%E6%BA%90%E7%A0%81%E5%89%96%E6%9E%90shadowsocks/  
